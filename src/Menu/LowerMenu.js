...
const LowerMenuWrapper = ({ xyData, executeGeoglows, executeBiasCorrection,executeHydroWebData, setDataObject, isFullMap,isHydroDataOn, isGeoglowsActive, isBiasCorrectionOn}) => {
